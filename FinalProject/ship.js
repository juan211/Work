...
function Ship(pos, r) {
  ...
  this.hits = function(asteroid) {
    ...
    var vertices = [
      p5.Vector.add(createVector(5 / 3 * this.r, this.r).rotate(this.heading), this.pos),
  ...
  this.render = function() {
    if (this.isDestroyed) {
      for (var i = 0; i < this.brokenParts.length; i++) {
        ...
        rotate(bp.heading);
        line(-this.r / 9, -this.r / 2, this.r / 2, this.r / 2);
        pop();
      }
    } else {
      push();
      ...
      triangle(4 / 5 * this.r, -this.r, 2 / 4 * this.r, this.r, 4 / 3 * this.r, 0);
