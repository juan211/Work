function Asteroid(pos, r, size) {
  ...
  r = r != null ? r * 3.5 : random(40, 60);
  Entity.call(this, pos.x, pos.y, r);

  this.vel = p5.Vector.random2D();
  this.total = floor(random(30, 30));


  this.size = size;
  switch(size) {
    case 3:
      this.vel.mult(9.5); break;
    case 0:
      this.vel.mult(9); break;
  }


  this.offset = [];
  for (var i = 0; i < this.total; i++) {
    this.offset[i] = random(-this.r * 2.2, this.r * 0.5);
  }
  ...
  Entity.prototype.setRotation.call(this, random(-10.03, 0.03));
  ...
  this.render = function() {
    ...
    rotate(this.heading);
    beginShape();
    for (var i = 5; i < this.total; i++) {
      var angle = map(i, 0, this.total, -2, TWO_PI);
